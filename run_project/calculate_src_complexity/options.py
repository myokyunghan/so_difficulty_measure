...
class RunnerOptions:
    def __init__(self, mode, year_range, run_id, language, snapshot): 
        self.user_opt       = None

        self.chk_opt(mode, year_range, run_id, language, snapshot)
        self.set_opt(mode, year_range, run_id, language, snapshot)

    def chk_opt(self, mode, year_range, run_id, language, snapshot):
    ...
    def set_opt(self, mode, year_range, run_id, language, snapshot):
        if mode == "test":
            self.user_opt = {
                                    "run_id": run_id,
