"""
Delphi Cognitive Complexity Calculator
Based on Campbell 2018 (ICSE TechDebt '18)

Installation: git clone https://github.com/AParks/tree-sitter-pascal.git && cd tree-sitter-pascal && pip install .
...
def create_parser():
    ...
    # 2. 개별 패키지
    try:
        import tree_sitter_pascal as _mod
