...
class CognitiveComplexityCalculator:
    ...
    def calculate(self):
        ...
        for ch in self.tree.root_node.children:
            if ch.type=="function_definition": self._proc(ch)
        return self.results
    ...
    def _proc(self, fn):
        ...
        self.details=[]
        c=0
        # MATLAB: children are function, output, name, args, \n, block, end
        for ch in fn.children:
            if ch.type=="block": c+=self._vc(ch,0)
    ...
    def _v(self,n,ne):
        ...
        if t in ("for_statement","while_statement"):
            ...
            for ch in n.children:
                if ch.type=="block": c+=self._vc(ch,ne+1)
            return c
        if t=="switch_statement":
            self._a(n,"switch",1,ne); c=1+ne
            for ch in n.children:
                if ch.type in ("case_clause","otherwise_clause"):
        ...
        if t=="catch_clause":
            ...
            for ch in n.children:
                if ch.type=="block": c+=self._vc(ch,ne+1)
            return c
        if t=="boolean_operator": return self._hbin(n,ne)
    ...
    def _hif(self,n,ne):
        ...
        for ch in n.children:
            if ch.type=="block": c+=self._vc(ch,ne+1); break
        for ch in n.children:
    ...
    def _cops(self,n,ops):
        if n.type!="boolean_operator": return
