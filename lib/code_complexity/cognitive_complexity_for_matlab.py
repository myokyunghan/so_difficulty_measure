...
def create_parser():
    """Prefer individual tree_sitter_matlab package because
    tree_sitter_language_pack may return a wrong/generic parser for
    matlab on some installations."""
    try:
    ...
    try:
        ...
        pass
    raise ImportError("Install: pip install tree-sitter-matlab")
