...
def create_parser():
    """Prefer individual tree_sitter_groovy package because
    tree_sitter_language_pack may return a wrong/generic parser for
    groovy on some installations."""
    try:
    ...
    try:
        ...
        pass
    raise ImportError("Install: pip install tree-sitter-groovy")
