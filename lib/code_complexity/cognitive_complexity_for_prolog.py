...
Installation: No maintained tree-sitter-prolog grammar. Returns empty.
...
def create_parser():
    """개별 패키지로 파서 생성"""
    try:
        import tree_sitter_prolog as _mod
        return Parser(Language(_mod.language()))
    except ImportError:
        raise ImportError("Install: pip install tree-sitter-prolog")
