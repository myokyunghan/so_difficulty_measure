...
def create_parser():
    """Prefer individual tree_sitter_typescript package because
    tree_sitter_language_pack may return a wrong/generic parser for
    typescript on some installations."""
    try:
        import tree_sitter_typescript as _mod
        _p = Parser(Language(_mod.language_typescript()))
        try:
    ...
    try:
        ...
        pass
    raise ImportError("Install: pip install tree-sitter-typescript")
